      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-4 left-4 z-30 flex items-center gap-4 text-xs text-gray-400 bg-brand-dark-2/70 backdrop-blur-sm rounded-lg px-4 py-2 border border-brand-accent/10">
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-sm bg-brand-green/60" /> {'<60%'}
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-sm bg-brand-yellow/60" /> {'60-80%'}
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-sm bg-brand-red/60" /> {'>80%'}
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-1 rounded-sm bg-brand-red animate-flash-red" /> N-1故障
          </span>
        </div>
      </div>
    </div>
